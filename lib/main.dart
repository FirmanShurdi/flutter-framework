...
class _AuthPageState extends State<AuthPage>
  ...
  Widget _buildPane({
    ...
    final offsetX = isLeft ? -28.0 : 28.0;
    ...
    return IgnorePointer(
      ...
      child: AnimatedOpacity(
        ...
        child: AnimatedSlide(
          duration: const Duration(milliseconds: 600),
          curve: Curves.easeOutCubic,
          offset: isVisible ? Offset.zero : Offset(offsetX / 100, 0),
          child: AnimatedScale(
            duration: const Duration(milliseconds: 600),
...
// ==========================================
// ARCHITECTURE: API SERVICE, REPOSITORY, PROVIDER
// ==========================================
...
class AuthProvider extends ChangeNotifier {
  ...
  Future<bool> register(String email, String password) async {
    ...
    try {
      _token = await _repository.register(email, password);
      _isLoading = false;
      notifyListeners();
      return true;
    } catch (e) {
